...
import {
  ...
  TrendingUp, Cpu, Database, FileText, Share2
} from 'lucide-react';

// Shared Util Import
import { getVerdictCategory } from '../utils/verdict';
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white pt-28 px-6 pb-20">
      <div className="max-w-7xl mx-auto">
        ...
        {/* --- System Intelligence Info Banner --- */}
        <motion.div
