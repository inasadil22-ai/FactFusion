                    ...
                    {hasHeatmap && (
                      <div className="flex flex-col p-10 rounded-[3rem] bg-white/[0.03] border border-white/10 backdrop-blur-3xl shadow-2xl hover:border-indigo-500/20 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(99,102,241,0.05)] transition-all duration-300">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center">
                          ...
                          {/* Method + Dominant Modality badges */}
                          <div className="mt-4 flex flex-wrap items-center gap-2 justify-center">
                            <span className={`text-[10px] px-3 py-1 rounded-lg border font-black uppercase ${xai.heatmap_status?.includes('AVAILABLE') ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-300' : 'bg-amber-500/10 border-amber-500/20 text-amber-300'}`}>
                            ...
                            {xai.heatmap_method && (
                              <span className="text-[10px] px-3 py-1 rounded-lg border font-black uppercase bg-blue-500/10 border-blue-500/20 text-blue-300">
                                {xai.heatmap_method === 'shap' ? '⚡ SHAP' : xai.heatmap_method === 'grad-cam' ? '🔥 Grad-CAM' : '🔍 CLIP'}
                              </span>
                            )}
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="p-10 rounded-[3rem] bg-white/[0.03] border border-white/10 backdrop-blur-3xl shadow-2xl hover:border-indigo-500/20 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(99,102,241,0.05)] transition-all duration-300">
                      ...
                      <div className="mt-6 space-y-3">
                        ...
                        {xai.text_attributions && xai.text_attributions.length > 0 && (() => {
                          ...
                          return (
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/10">
                              <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-2">📝 Text Evidence</p>
                        ...
                        {hasImage && (
                          <div className="p-4 bg-white/5 rounded-2xl border border-white/10">
                            <p className="text-[10px] font-black text-purple-400 uppercase tracking-widest mb-2">🖼 Image Evidence</p>
                            <p className="text-xs text-white/70">
                              ...
                              {xai.heatmap_method && ` · Explained via ${xai.heatmap_method.toUpperCase()}`}
                            </p>
                          </div>
                        )}
                        ...
                        {/* Dominant modality */}
                        {xai.dominant_modality && (
                          <div className={`p-4 rounded-2xl border ${xai.dominant_modality === 'image' ? 'bg-red-500/5 border-red-500/20' : 'bg-purple-500/5 border-purple-500/20'}`}>
                            <p className="text-[10px] font-black uppercase tracking-widest mb-1 ${xai.dominant_modality === 'image' ? 'text-red-400' : 'text-purple-400'}">
                              ⚡ Decision Driver
                            </p>
                            <p className="text-xs text-white/70">
                              The <span className="font-bold text-white">{xai.dominant_modality}</span> modality had stronger evidence and primarily drove this verdict.
                            </p>
                          </div>
                        )}
                      </div>
